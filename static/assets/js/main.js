(function ($) {
  ...
  jQuery(window).on("load", function () {
    ...
    $(".instagram-carousel").slick({
      ...
      arrows: true,
      prevArrow:
        '<button type="button" class="slick-prev"><i class="ti-angle-right"></i></button>',
      nextArrow:
        '<button type="button" class="slick-next"><i class="ti-angle-left"></i></button>',
      responsive: [
        {
          breakpoint: 1499,
          settings: {
  ...
  $("#price-range").slider({
    ...
    slide: function (event, ui) {
      $("#price-amount").val(
        "قیمت: " + "تومان" + ui.values[0] + " - تومان" + ui.values[1]
      );
    }
  });
  $("#price-amount").val(
  ...
  $(".shop-product__big-image-gallery-slider").each(function () {
    ...
    $this.slick({
      ...
      rows: $row,
      prevArrow:
        '<button class="slick-prev"><i class="ti-angle-right"></i></button>',
      nextArrow:
        '<button class="slick-next"><i class="ti-angle-left"></i></button>',
